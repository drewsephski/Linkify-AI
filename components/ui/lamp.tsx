		...
		>
			<div className="relative isolate z-0 flex w-full flex-1 scale-y-125 items-center justify-center ">
				<motion.div
					...
					className="absolute inset-auto right-1/2 h-56 w-[30rem] overflow-visible bg-gradient-conic from-blue-600 via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]"
				>
				...
				<motion.div
					...
					className="-translate-y-[6rem] absolute inset-auto z-30 h-36 w-64 rounded-full bg-blue-400 blur-2xl"
				></motion.div>
				<motion.div
					initial={{ width: "15rem" }}
					...
					className="-translate-y-[7rem] absolute inset-auto z-50 h-0.5 w-[30rem] bg-blue-400"
				></motion.div>
